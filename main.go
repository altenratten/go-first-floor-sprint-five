...
func (t Training) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	return InfoMessage{TrainingType: t.TrainingType, Duration: t.Duration, Distance: t.distance(), Speed: t.meanSpeed(), Calories: 0}
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	return InfoMessage{TrainingType: s.Training.TrainingType, Duration: s.Training.Duration, Distance: SwimmingLenStep * float64(s.Action) / MInKm, Speed: s.meanSpeed(), Calories: 0}
}
